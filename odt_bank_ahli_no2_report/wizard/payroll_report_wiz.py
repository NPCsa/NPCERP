...
class PayrollBankAhliN2(models.TransientModel):
    _name = 'bank.ahli.n2.wiz'
    ...
    def print_report(self):
        return self.env.ref('odt_bank_ahli_no2_report.report_bank_ahli_n2_xlsx').report_action(self)
