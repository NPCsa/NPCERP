...
class AccountInvoice(models.Model):
    ...
    def _compute_amount(self):
        ...
        if self.currency_id and self.currency_id != self.company_id.currency_id:
            ...
            amount_total_company_signed = currency_id._convert(self.amount_total, self.company_id.currency_id,self.company_id,date.today())
            amount_untaxed_signed = currency_id._convert(self.amount_untaxed, self.company_id.currency_id,self.company_id,date.today())
