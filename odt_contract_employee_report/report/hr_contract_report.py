        ...
        if employees:
            for employee in employees:
                ...
                for contract in contract_ids:
                    line = [contract.name,contract.state, contract.date_start, contract.date_end, contract.type_id.name,
                            contract.job_id.name, contract.zw_idara.name, contract.department_id.name, contract.wage,
