...
class PayrollXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, payslips):
        ...
        sheet.merge_range('H7:O7', 'Payslips', format2)
        sheet.merge_range('H8:I8', 'Date ', format2)
        sheet.merge_range('L10:K10', str('Payslips Status ' + str(state)), format2)
        sheet.merge_range('J8:O8', str(' From  ' + str(from_date) + 'To  ' + str(to_date)), format2)
        sheet.merge_range('A12:A13', 'Employee ID', format2)
        sheet.merge_range('B12:B13', 'Employee', format2)
        sheet.merge_range('C12:C13', 'Idara', format2)
        sheet.merge_range('D12:D13', 'Department', format2)
        sheet.merge_range('E12:E13', 'Job', format2)
        sheet.merge_range('F12:F13', 'Create Date', format2)
        sheet.merge_range('G12:N12', 'Allowances', format2)
        sheet.write(12, 6, 'Basic Salary', format2)
        sheet.write(12, 7, 'Housing ', format2)
        sheet.write(12, 8, 'Transportation ', format2)
        sheet.write(12, 9, 'Mobile ', format2)
        sheet.write(12, 10, 'OverTime ', format2)
        sheet.write(12, 11, 'Work ', format2)
        sheet.write(12, 12, 'Reward ', format2)
        sheet.write(12, 13, 'Other ', format2)
        sheet.merge_range('O12:O13', 'Gross', format2)
        sheet.merge_range('P12:U12', 'Deductions', format2)
        sheet.write(12, 15, ' Social Insurance ', format2)
        sheet.write(12, 16, ' Absent & Late ', format2)
        sheet.write(12, 17, ' Loan ', format2)
        sheet.write(12, 18, ' Unpaid Leave ', format2)
        sheet.write(12, 19, ' Sanction ', format2)
        sheet.write(12, 20, ' Other ', format2)
        sheet.merge_range('V12:V13', 'Total Deduction ', format2)
        sheet.merge_range('W12:W13', 'NET ', format2)
